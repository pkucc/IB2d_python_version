...
class DeepQNetwork:
    def __init__(
        ...
        self.policy_net = DQN(self.n_features, self.n_actions).to(self.device)
        self.target_net = DQN(self.n_features, self.n_actions).to(self.device)
    ...
    def learn(self):
        ...
        self.cost_his.append(np.linalg.norm(loss))
