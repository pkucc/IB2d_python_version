...
class Flow_Field():
    ...
    def step(self, action):
        ...
        self.update_file_with_line_func('update_nonInv_Beams.py', update_kStiff)
        ...
        self.update_file_with_line_func('input2d', update_restart)
        ...
        if self.currentTime < self.endTime:
            ...
            self.update_file_with_line_func('update_nonInv_Beams.py', recover_kStiff)
        ...
        # 返回observation
        s_ = [self.massCenter[0], self.massCenter[1], self.Force[0], self.Force[1], math.log(self.current_k)]
        s_ = np.array(s_)
